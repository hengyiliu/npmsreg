              ...
              <div>
                <Form onSubmit={props.handleSubmit}>
                  <FormGroup row>
                    ...
                    <Col md={8}>
                      <Input tag={Field} name="firstName" type="text" />
                    </Col>
                  </FormGroup>
                  <FormGroup row>
                    <Col md={4}>
                    ...
                    <Col md={8}>
                      <Input tag={Field} name="lastName" type="text" />
                    </Col>
                  </FormGroup>
                  <FormGroup row>
                    <Col md={4}>
                    ...
                    <Col md={8}>
                      <Input tag={Field} name="chineseName" type="text" />
                    </Col>
                  </FormGroup>
                  <FormGroup row>
                    <Col md={4}>
                    ...
                    <Col md={8}>
                      <Input tag={Field} name="birthday" type="text" />
                    </Col>
                  </FormGroup>
                  <FormGroup row>
                    <Col md={4}>
                    ...
                    <Col md={8}>
                      <Input tag={Field} name="gender" type="text" />
                    </Col>
                  </FormGroup>
                  <FormGroup row>
                    <Col md={4}>
                    ...
                    <Col md={8}>
                      <Input tag={Field} name="grade" type="text" />
                    </Col>
                  </FormGroup>
                  <Button disabled={props.isSubmitting}>Submit</Button>&nbsp;
                  <Button type="button" onClick={this.props.closeModalHandler}>
                    Cancel
                  </Button>
                </Form>
              </div>
